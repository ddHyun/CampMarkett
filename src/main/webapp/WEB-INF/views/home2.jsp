	...
	<div class="main">
			...
			<div class="zerogrid">
				<div class="col-full">
					<div class="wrap-col">
						<h1>
							<a href="home2"><img
								src="resources/assets/img/images/logo2.png" alt="EXTERIOR"></a>
						</h1>
						...
						<div class="menu_block">
							<nav>
								...
								<ul class="sf-menu">
									...
									<li><a href="#">로그인 : ${sessionScope.loginId}</a></li>
									<li><a href="resources/assets/html/index-2.html">밀키트</a></li>
									<li><a href="resources/assets/html/index-3.html">후기</a></li>
									<li><a href="resources/assets/html/index-4.html">주변
											캠핑장 </a></li>
									<li class="with_ul" id="memberMenu"><a
										href="resources/assets/html/index-1.html">회원 정보</a>
										<ul>
		...
		<div class="slider-relative">
			<div class="slider-block">
				<div class="slider">
					<ul class="items">
						<li><img src="resources/assets/img/images/campingphoto1.jpg" alt=""></li>
						<li><img src="resources/assets/img/images/campingphoto2.jpg" alt=""></li>
						<li><img src="resources/assets/img/images/campingphoto4.png" alt=""></li>
						<li class="mb0"><img
							src="resources/assets/img/images/slide2.jpg" alt=""></li>
					</ul>
				</div>
			</div>
		</div>
		...
		<div class="content page1">
			<div class="zerogrid">
				<div class="row" >
					<div class="wrap-col" style="width:100%; margin:0 auto;">
							<div class="test" style="width:100%; margin:0 auto; text-align:center;">
								<h2>Welcome</h2>
