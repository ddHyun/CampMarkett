         ...
         <div class="menu_block">
           <nav>
            <ul class="sf-menu">
                   ...
                   <li><a href="index-2.html">밀키트</a></li>
                   <li><a href="index-3.html">후기</a></li>
                   <li><a href="index-4.html">주변 캠핑장 </a></li>
                   <li class="with_ul"><a href="index-1.html">회원 정보</a>
				   	<ul>
                   ...
                   <li><a href="index-4.html">로그인</a></li>
                 </ul>
           </nav>
           <div class="clear"></div>
           </div>
      ...
      <div class="col-3-5">
	  	<div class="wrap-col">
	        ...
	        <div class="page1_block col1">
				<div class="col-1-3"><img src="resources/assets/img/images/welcome_img.png" alt=""></div>
				<div class="col-2-3">
