...
①“몰” 이란 (주)스타럭스가 재화 또는 용역(이하 “재화 등”이라 함)을 이용자에게 제공하기 위하여 컴퓨터 등 정보통신설비를 이용하여 재화 등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.
...
②“몰”과 이용자간에 제기된 전자상거래 소송에는 한국법을 적용합니다.
	...
	<div>
		<textarea rows="20" cols="100">
'CampMarket'은 회원님께서 ㈜캠핑가즈아가 운영하는 웹사이트(이하'레스포색몰'이라고 함)의 각종 서비스를 이용하거나'레스포색몰'(www.lesportsackorea.com)의 상품을 주문하는데 있어, 본인확인, 원활한 서비스 제공 및 주문 접수, 물품 배송, 대금 결제, 회원님에게 유용한 맞춤정보 제공 등을 위하여 필요한 최소한의 개인정보를 필수 사항으로 수집합니다.
